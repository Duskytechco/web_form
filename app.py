...
class MyApp(Flask):
    ...
    def submitFirstPage(self):
        try:
            ...
            print("First Page Dictionary",self.firstPageData, flush=True)
            print("NRIC :", self.firstPageData['NRIC'], flush=True)
    ...
    def submit(self):
        print("From Second page (DATA): ", self.firstPageData, flush=True)
        print("From Second page (NRIC): ", self.firstPageData['NRIC'], flush=True)
    ...
    def restructureFirstPageInfo(self):
        ...
        print('DEBUGGING DATA: ',data, flush=True)
        print('DEBUGGING Personal Info: ',self.personalInfo, flush=True)
        print('DEBUGGING Product Info: ',self.productInfo, flush=True)
    ...
    def restructureSecondPageInfo(self):
        try: 
            ...
            print("Debugging 4", flush=True)


            print("DEBUGGING Working Info: ", self.workingInfo, flush=True)
            print("DEBUGGING Banking Info: ", self.bankingInfo, flush=True)
            print("DEBUGGING Extra Info: ", self.extraInfo, flush=True)
